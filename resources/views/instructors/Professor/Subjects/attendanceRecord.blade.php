...
<div class="row" style="margin-bottom: 20px">
    ...
    <div class="col-lg-8">
        ...
        <a href="{{route('attendanceRecord' , ['subject_id' => $subject_id , 'group_id' => $group_id])}}" class="btn btn-success btn-md"><i class="icon-people"></i>  سجل الحضور</a>
    ...
    <div class="col-lg-2"  >
        <a style="padding-left: 5px"class="btn btn-primary" href="{{route('AttendanceRecordAction', ['subject_id' => $subject_id , 'group_id' => $group_id])}}">إضافة سجل جديد [تاريخ اليوم]</a>
 
    </div>
    <div class="col-lg-2">
         
        <a class="btn btn-primary" href="{{route('AttendanceSheet', ['subject_id' => $subject_id , 'group_id' => $group_id])}}">طباعة السجل</a>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center">
                                        <p class="text-success font-weight-bold " style="text-align: center">
                                            {{App\Models\student_attendanceRecord::CountPresent($records->date ,$subject_id ,$group_id) }}
                                        </p>
                                    ...
                                    <td style="text-align: center"> 
                                        <p class="text-danger font-weight-bold">
                                            ...
                                            {{App\Models\student_attendanceRecord::CountUpsent($records->date ,$subject_id ,$group_id) }}
                                        </p>
                                    ...
                                    <td style="text-align: center">
                                        ...
                                        <a class="btn btn-primary" href="{{route('attendanceEdit' , ['date' => $records->date , 'subject_id' => $subject->id , 'group_id' => $group_id] )}}">عرض</a>
